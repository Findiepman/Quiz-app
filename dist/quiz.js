...
const answerLabels = Array.from(document.querySelectorAll(".answer-option"));
const answerSpans = Array.from(document.querySelectorAll(".answer-text"));
...
function renderQuestion() {
    ...
    answerLabels.forEach((label, i) => {
        ...
        // Reset Styles & State
        const card = label.querySelector(".answer-card");
...
function handleAnswerClick(selectedIndex, questionId) {
